...
public class ColorViewController {
    ...
    @PostMapping
    public String saveColor(@ModelAttribute Color color, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String updateColor(@PathVariable Long id, @ModelAttribute Color color, RedirectAttributes redirectAttributes) {
        try {
    ...
    public String deleteColor(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("error", "Failed to delete color: " + ex.getMessage());
        }
        return "redirect:/colors";
    }
} 